...
#  # UNCOMMENT THIS SECTION IF YOU WANT TO GET THE INPUT NUMBERS

# print(x_input_numbers)
# for i in range(900, 1000):
#     inputs = x_input_numbers[i]
#     f = open("inputs.txt", "a")
#     s = str(i) + " : " + str(inputs)
#     f.write(s)
#     f.write("\n")
...
#  # UNCOMMENT THIS SECTION IF YOU WANT TO GENERATE PROMPTS
